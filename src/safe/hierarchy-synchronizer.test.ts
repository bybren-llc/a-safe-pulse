  ...
  describe('synchronizeHierarchy', () => {
    it('should synchronize the SAFe hierarchy', async () => {
      ...
      const planningDocument: PlanningDocument = {
        ...
        epics: [
          { id: 'epic1', type: 'epic', title: 'Epic 1', description: 'Epic 1 description', attributes: {}, features: [] },
          { id: 'epic2', type: 'epic', title: 'Epic 2', description: 'Epic 2 description', attributes: {}, features: [] }
        ],
        features: [
          { id: 'feature1', type: 'feature', title: 'Feature 1', description: 'Feature 1 description', epicId: 'epic1', attributes: {}, stories: [], enablers: [] },
          { id: 'feature2', type: 'feature', title: 'Feature 2', description: 'Feature 2 description', epicId: 'epic2', attributes: {}, stories: [], enablers: [] }
        ],
        stories: [
          { id: 'story1', type: 'story', title: 'Story 1', description: 'Story 1 description', featureId: 'feature1', attributes: {}, acceptanceCriteria: ['Story 1 criteria'] },
          { id: 'story2', type: 'story', title: 'Story 2', description: 'Story 2 description', featureId: 'feature2', attributes: {}, acceptanceCriteria: ['Story 2 criteria'] }
        ],
        enablers: [
