...
# apply-workflow.sh
# This script integrates the ASP SAFe-Agentic-Workflow template into your project.
...
# --- Main Script ---
log_info "Starting ASP SAFe-Agentic-Workflow integration..."
...
log_success "ASP SAFe-Agentic-Workflow integration complete!"
log_info "Next steps:"
