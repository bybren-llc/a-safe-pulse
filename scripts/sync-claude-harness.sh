...
UPSTREAM_REPO="bybren-llc/a-safe-pulse"
...
load_config() {
    if [ -f "$SYNC_CONFIG" ]; then
        UPSTREAM_REPO=$(json_get "$SYNC_CONFIG" "upstream_repo" "bybren-llc/a-safe-pulse")
...
#     to prevent partial matches (e.g., https://github.com/bybren-llc/a-safe-pulse before bybren-llc)
...
# Output: lines like "rel_path:42: unreplaced token a-safe-pulse"
