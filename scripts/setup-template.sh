...
declare -a REPLACEMENTS=(
  "https://github.com/bybren-llc/a-safe-pulse|${GITHUB_REPO_URL}"
  "ghcr.io/bybren-llc|${CONTAINER_REGISTRY}"
  "asp-staging|${STAGING_CONTAINER}"
  "asp|${TICKET_PREFIX_LOWER}"
  "app|${DEV_CONTAINER}"
  "db|${DB_CONTAINER}"
  "postgres|${DB_PASSWORD}"
  "cheddarfox.com|${PROJECT_DOMAIN}"
  "ASP|${PROJECT_SHORT}"
  "a-safe-pulse|${PROJECT_REPO}"
  "a-safe-pulse|${PROJECT_NAME}"
  "ByBren, LLC|${COMPANY_NAME}"
  "https://cheddarfox.com|${AUTHOR_WEBSITE}"
  "Scott|${AUTHOR_FIRST_NAME}"
  "Graham|${AUTHOR_LAST_NAME}"
  "S. G.|${AUTHOR_INITIALS}"
  "cheddarfox|${AUTHOR_HANDLE}"
  "scott@cheddarfox.com|${AUTHOR_EMAIL}"
  "Scott Graham|${AUTHOR_NAME}"
  "scott@cheddarfox.com|${SECURITY_EMAIL}"
  "ASP|${TICKET_PREFIX}"
  "cheddarfox|${LINEAR_WORKSPACE}"
  "dev|${MAIN_BRANCH}"
  "cheddarfox|${ARCHITECT_GITHUB_HANDLE}"
  "bybren-llc|${GITHUB_ORG}"
  "postgres|${DB_USER}"
  "linear_agent|${DB_NAME}"
  "linear-mcp|${MCP_LINEAR_SERVER}"
  "confluence-mcp|${MCP_CONFLUENCE_SERVER}"
  "v2.10.0|${HARNESS_VERSION}"
)
