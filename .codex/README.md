...
Since Codex uses natural language instead of slash commands, describe the SAFe workflow step you want to execute conversationally (e.g., "Start work on ASP-42" instead of `/start-work ASP-42`).
