...
Prompt: "Review PR #XXX for ASP-YYY. Validate:
...
All QAS reports go to: `docs/agent-outputs/qa-validations/ASP-{number}-qa-validation.md`
...
- **a-safe-pulse**: Core agentic principles
