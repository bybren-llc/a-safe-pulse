...
- Start work on a Linear ticket (e.g., "I'm starting ASP-447")
...
Enforces SAFe-compliant development workflow with proper branch naming (`ASP-{number}-{description}`), standardized commit messages (type, scope, description), and rebase-first git workflow. Ensures all work is traceable to Linear tickets.
