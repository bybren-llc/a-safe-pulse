...
ls specs/
cat specs/SPEC-ASP-XXX-example.md
```
...
| ------------ | ----------------------------------------------------- |
| Impl specs   | `specs/SPEC-ASP-{number}-{description}.md`            |
| Requirements | `docs/agent-outputs/requirements/ASP-{number}-*.md`   |
...
**Spec**: specs/SPEC-ASP-{number}-{description}.md
