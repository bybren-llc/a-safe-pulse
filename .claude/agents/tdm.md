...
- PR #123: [ASP-XXX] - [Status]
- PR #124: [ASP-XXX] - [Status]
...
```bash
# Agent 1: FE Developer on ASP-123
# Agent 2: BE Developer on ASP-124
...
```bash
# Agent 1: DE creates migration (ASP-125)
# Agent 2: BE implements API (ASP-126) - depends on ASP-125
# TDM ensures ASP-125 merged before ASP-126 starts
```
