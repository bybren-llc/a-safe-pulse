...
- Atomic commits in SAFe format: `feat(api): description [ASP-XXX]`
...
3. **Handoff Statement**
   > "BE implementation complete for ASP-XXX. All validation passing. AC/DoD confirmed. Ready for QAS review."
