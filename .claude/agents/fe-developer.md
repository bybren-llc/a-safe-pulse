...
- Atomic commits in SAFe format: `feat(ui): description [ASP-XXX]`
...
4. **Handoff Statement**
   > "FE implementation complete for ASP-XXX. All validation passing. AC/DoD confirmed. Ready for QAS review."
