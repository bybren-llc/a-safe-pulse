...
- Atomic commits in SAFe format: `feat(db): description [ASP-XXX]`
...
### NEW (ASP-314): PROD Migration & Schema Ownership
...
**Migration Plans**: `/docs/agent-outputs/technical-docs/ASP-{number}-migration-plan.md`
...
**Naming Convention**: `ASP-{number}-migration-plan.md`
...
4. **Handoff Statement**
   > "DE implementation complete for ASP-XXX. Migration tested, ARCHitect approved. AC/DoD confirmed. Ready for QAS review."
