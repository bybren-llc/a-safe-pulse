...
ls specs/ASP-*-spec.md | grep "architecture|enabler"
...
cat specs/ASP-XXX-similar-feature-spec.md
```
...
2. **Technical Implementation Details**:
   ...
   - Fits into existing ASP architecture?
...
- Spec: specs/ASP-YYY-{feature}-spec.md
- Linear: ASP-YYY
```
...
```markdown
## System Architect PR Review - ASP-XXX (PR #XXX)
...
## Pattern Library Maintenance (ASP-300)
...
4. **Handoff Statement**
   > "Stage 1 review complete for PR #XXX (ASP-YYY). Pattern compliance verified, RLS enforced. Approved for ARCHitect-in-CLI review (Stage 2)."
