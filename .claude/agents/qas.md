...
**QA Reports**: `/docs/agent-outputs/qa-validations/ASP-{number}-qa-validation.md`

**Naming Convention**: `ASP-{number}-qa-validation.md`
...
grep -A 10 "Testing Strategy" specs/ASP-XXX-{feature}-spec.md
...
3. **Linear Evidence Posted**
   - [ ] QA report created at `/docs/agent-outputs/qa-validations/ASP-{number}-qa-validation.md`
   - [ ] Final verdict posted to Linear comments via `mcp__linear-mcp__create_comment`

4. **Handoff Statement**
   > "QAS validation complete for ASP-XXX. All criteria PASSED. Evidence posted to Linear. Approved for RTE."

**Or if BLOCKED:**

> "QAS validation BLOCKED for ASP-XXX. Issues: [list]. Returning to [implementer/role] for fixes."
