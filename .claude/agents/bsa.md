...
### 0. Check Pattern Library FIRST (MANDATORY - ASP-300)
...
```bash
# Create spec file for ASP-XXX
cp specs/spec_template.md specs/ASP-XXX-{description}-spec.md
```

#### Step 2: Extract from User Story

**From Linear ticket (ASP-XXX)**:
...
ls specs/ASP-*-spec.md | grep "similar_feature"
...
- Implement [feature] as specified in ASP-XXX
...
- Internal dependencies (a-safe-pulse components)
...
From spec, add subtasks to ASP-XXX:
