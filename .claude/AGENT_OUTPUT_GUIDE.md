...
| -------------------------------------- | --------------------------------------- | --------------------------------- |
| **QAS** (Quality Assurance Specialist) | `/docs/agent-outputs/qa-validations/`   | `ASP-{number}-qa-validation.md`   |
| **BSA** (Business Systems Analyst)     | `/docs/agent-outputs/requirements/`     | `ASP-{number}-requirements.md`    |
| **System Architect**                   | `/docs/adr/`                            | `ADR-{number}-{title}.md`         |
| **Tech Writer**                        | `/docs/agent-outputs/technical-docs/`   | `ASP-{number}-technical-docs.md`  |
| **Data Engineer**                      | `/docs/agent-outputs/technical-docs/`   | `ASP-{number}-migration-plan.md`  |
| **TDM** (Technical Delivery Manager)   | `/docs/agent-outputs/delivery-reports/` | `ASP-{number}-delivery-report.md` |
...
**Output Location**: `/docs/agent-outputs/qa-validations/ASP-{number}-qa-validation.md`
...
**Output Location**: `/docs/agent-outputs/requirements/ASP-{number}-requirements.md`
...
**Output Location**: `/docs/agent-outputs/technical-docs/ASP-{number}-technical-docs.md`
...
**Output Location**: `/docs/agent-outputs/technical-docs/ASP-{number}-migration-plan.md`
...
cat > /docs/agent-outputs/qa-validations/ASP-334-qa-validation.md <<EOF
## QA Validation Report - ASP-334
...
cat > /docs/agent-outputs/requirements/ASP-335-requirements.md <<EOF
## Requirements - ASP-335
...
cat > /docs/agent-outputs/technical-docs/ASP-336-migration-guide.md <<EOF
## Migration Guide - ASP-336
...
1. **During Work**: Agents write to `/docs/agent-outputs/{category}/ASP-{number}-*.md`
...
✅ Use Linear ticket number in filename (`ASP-{number}-*`)
