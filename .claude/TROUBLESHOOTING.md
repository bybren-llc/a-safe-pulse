...
3. **Ticket prefix mismatch**
   ...
   If command references `ASP-XXX` but your project uses different prefix,
...
3. **Hook command fails silently**
   ...
   git branch --show-current 2>/dev/null | grep -q '^ASP-[0-9]'
...
2. **Read the Whitepaper** - `docs/whitepapers/CLAUDE-CODE-HARNESS-MODERNIZATION-ASP-444.md`
