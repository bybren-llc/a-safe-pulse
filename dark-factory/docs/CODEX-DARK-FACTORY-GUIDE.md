...
+------------------------------ Remote Server ----------------------------+
|                                                                         |
|  tmux session: codex-factory-ASP-123                      |
|  +-------------------------------------------------------------------+ |
...
tmux new-session -d -s "codex-factory-ASP-123"

# Window 1: TDM (team lead)
tmux rename-window -t "codex-factory-ASP-123:1" "TDM"
tmux send-keys -t "codex-factory-ASP-123:TDM" \
  "cd {{PROJECT_PATH}} && codex-yolo codex --agent tdm \
  'You are leading work on ASP-123. Read the spec and coordinate.'" Enter

# Window 2: BE Developer
tmux new-window -t "codex-factory-ASP-123" -n "BE-Dev"
tmux send-keys -t "codex-factory-ASP-123:BE-Dev" \
  "cd {{PROJECT_PATH}} && codex-yolo codex --agent be-developer" Enter

# Window 3: QAS
tmux new-window -t "codex-factory-ASP-123" -n "QAS"
tmux send-keys -t "codex-factory-ASP-123:QAS" \
  "cd {{PROJECT_PATH}} && codex-yolo codex --agent qas" Enter

# Window 4: Control (audit log)
tmux new-window -t "codex-factory-ASP-123" -n "Control"
tmux send-keys -t "codex-factory-ASP-123:Control" \
  "tail -f ~/.codex-yolo/audit.log" Enter

# Attach
tmux attach -t "codex-factory-ASP-123"
```
...
tmux list-windows -t "codex-factory-ASP-123"
