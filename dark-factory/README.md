...
tail -f ~/.dark-factory/logs/factory-ASP-42/*.log

# Jump into a specific agent's pane to observe
./dark-factory/scripts/factory-attach.sh factory-ASP-42 2

# End of day: Graceful shutdown
./dark-factory/scripts/factory-stop.sh factory-ASP-42
```
...
```bash
./dark-factory/scripts/factory-attach.sh factory-ASP-42 4
...
3. Attach read-only: `tmux attach -t factory-ASP-42 -r`
