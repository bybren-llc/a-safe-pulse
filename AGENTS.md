...
cp specs_templates/spec_template.md specs/ASP-XXX-{feature}-spec.md
...
**Product Owner / Product Manager**: Scott Graham
...
# Coordination
@tdm Coordinate implementation of ASP-123 user profile feature
@rte Create PR for ASP-123 and run CI validation
```
...
Task({
  subagent_type: "bsa",
  description: "Create spec for ASP-123",
  prompt: `Create comprehensive spec for ASP-123 user profile feature.
...
Task({
  ...
  description: "Implement ASP-123 API",
  prompt: `Read spec at specs/ASP-123-user-profile-spec.md
...
Task({
  subagent_type: "qas",
  description: "Test ASP-123 feature",
  prompt: `Read spec at specs/ASP-123-user-profile-spec.md
...
Task({
  subagent_type: "tdm",
  description: "Resolve blocker for ASP-123",
  prompt: `A blocker has been reported for ASP-123.
...
1. **Always reference specs**: `Read spec at specs/ASP-XXX-spec.md`
