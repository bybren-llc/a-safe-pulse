...
2. **Run the `apply-workflow.sh` script.**
   ...
   git clone https://github.com/bybren-llc/a-safe-pulse.git /tmp/cheddarfox-workflow-template

   # Then, run the script from your project's root
   bash /tmp/cheddarfox-workflow-template/apply-workflow.sh
   ```
...
2. **Report Issues**:
   - Found a bug? [Open an issue](https://github.com/bybren-llc/a-safe-pulse/issues)
   - Have a feature request? [Start a discussion](https://github.com/bybren-llc/a-safe-pulse/discussions)
...
1. **Create a spec**: `cp specs_templates/spec_template.md specs/ASP-123-my-feature-spec.md`
