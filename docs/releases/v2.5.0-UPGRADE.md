...
- [PR #22](https://github.com/bybren-llc/a-safe-pulse/pull/22) -- Implementation PR
- [WOR-540](https://linear.app/cheddarfox/issue/WOR-540) -- Epic ticket

---

*This upgrade guide is part of the [ASP SAFe Agentic Workflow](https://github.com/bybren-llc/a-safe-pulse) harness.*
