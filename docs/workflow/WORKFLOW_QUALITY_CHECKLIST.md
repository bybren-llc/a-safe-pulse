...
## ASP-321 Retrospective Check

**Purpose**: Prevent ASP-321-type gaps in future work
...
**"Would ASP-321 gap happen with this workflow?"**

- [ ] **NO** → Proceed with confidence
- [ ] **YES** → Fix before PR
- [ ] **UNSURE** → Review ASP-321 report, invoke System Architect

### ASP-321 Gap Indicators
...
**Example**: ASP-321 documentation files (runbooks, best practices)
