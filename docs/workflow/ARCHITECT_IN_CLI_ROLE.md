...
**CRITICAL UPDATE (v1.1)**: Based on ASP-321 gap discovery, System Architect review is **MANDATORY** for complex code.
...
Task({
  ...
  description: "Review ASP-XXX automation scripts",
  prompt: `Architectural review required for ASP-XXX deliverables.
...
Reference: ASP-XXX investigation findings`,
});
```
...
**ASP-321 Lesson**: Correct specialist selection, but MISSING System Architect review
...
## Role Collapsing Authority (ASP-499)
...
- **Added**: Role Collapsing Authority section (ASP-499)
...
- **Added**: ASP-321 retrospective and gap analysis
- **Added**: Pattern 3 (Complex Automation with MANDATORY review)
- **Rationale**: Prevent ASP-321-type gaps (unreviewed complex code)
