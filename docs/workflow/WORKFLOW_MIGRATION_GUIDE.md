...
**Date**: 2025-10-06
**Audience**: Development teams working on ASP-app
...
3. **WAIT FOR TDM PRE-GATE** 👈 NEW
   - TDM verifies branch naming: ASP-XXX-...
...
# Must be: ASP-{number}-{description}
# Example: ASP-321-free-tools-bonus
...
- Required: ASP-XXX-free-tools-bonus
...
- Make atomic commits: `type(scope): description [ASP-XXX]`
...
```sql
PR created → Scott reviews → Scott Graham merges
```text
...
- [x] Branch: ASP-321-free-tools-bonus
