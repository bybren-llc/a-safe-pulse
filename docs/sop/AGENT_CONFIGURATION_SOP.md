...
**Owner**: ASP Development Team

---

## Overview

This SOP defines how to configure and maintain the 11-agent system for the ASP application.
...
- **Boundaries**: Scott Graham (HITL) remains final merge authority. RTE shepherds PRs to "Ready for HITL Review"
...
**Questions?** Contact ASP Development Team or System Architect
