...
- [ ] **Bash scripts >100 lines** → MANDATORY System Architect review
  ...
  - ASP-XXX Gap: 710-line `deploy-migration-prod.sh` delivered without review

- [ ] **CI/CD workflow created/modified** → MANDATORY System Architect review
  - Example: GitHub Actions workflows, pipeline changes
  - ASP-XXX Gap: 641-line `migration-validation.yml` delivered without review
...
- [ ] **Validation/verification scripts >200 lines** → MANDATORY System Architect review
  ...
  - ASP-XXX Gap: 3 TypeScript scripts delivered without review
...
- [ ] Branch naming: `ASP-{number}-{description}` or `__TICKET_PREFIX__-{number}-{description}`
...
## Example: ASP-321 Failure Analysis
...
**This checklist prevents architectural governance gaps like ASP-321**
