> **📚 EXAMPLE**: This document is preserved as a learning example from the ASP project. It demonstrates the pattern for documenting significant plan changes with clear rationale and impact analysis. When adopting this workflow, create your own version tailored to your project.
...
3. **Create Linear Ticket**: e.g., ASP-XXX
