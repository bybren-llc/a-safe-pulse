...
Task({
  ...
  prompt:
    "Create comprehensive spec for ASP-123 user profile feature. Include pattern discovery, acceptance criteria, and testing strategy. Reference existing patterns from patterns_library/.",
});
```
...
```
@tdm I need to implement ASP-123 (user profile feature).
