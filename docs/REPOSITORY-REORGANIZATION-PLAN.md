> **📚 EXAMPLE**: This document is preserved as a learning example from the ASP project. It demonstrates the pattern for planning a comprehensive repository reorganization with detailed implementation steps. When adopting this workflow, create your own version tailored to your project.
...
│   │
│   ├── onboarding/             ✅ KEEP AS IS (recently created for ASP-326)
│   │   ├── AGENT-SETUP-GUIDE.md
│   │   ├── DAY-1-CHECKLIST.md
│   │   ├── META-PROMPTS-FOR-USERS.md
│   │   ├── USER-JOURNEY-VALIDATION-REPORT.md
│   │   └── ASP-326-COMPLETION-SUMMARY.md
│   │
...
**docs/onboarding/ASP-326-COMPLETION-SUMMARY.md**:
...
# Phase 5: Commit
git add -A
git commit -m "docs: reorganize root directory documentation [ASP-XXX]
...
**Recommended Ticket**: Create new Linear ticket (e.g., ASP-327) for this reorganization work
