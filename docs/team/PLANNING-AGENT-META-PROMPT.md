...
3. **ASP Methodology** - Evidence-Based, Pattern-Driven, Spec-Driven
...
1. **Specs Directory**: `ls specs/ASP-*-spec.md | grep "similar"`
...
```bash
cp specs/planning_template.md specs/ASP-XXX-{initiative}-planning.md
```
