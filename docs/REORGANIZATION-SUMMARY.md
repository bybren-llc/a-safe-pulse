> **📚 EXAMPLE**: This document is preserved as a learning example from the ASP project. It demonstrates the pattern for creating an executive summary for a repository reorganization plan. When adopting this workflow, create your own version tailored to your project.
...
2. **Create Linear Ticket**: e.g., ASP-XXX
...
**Recommendation**: Create Linear ticket (e.g., ASP-XXX) and execute reorganization as part of ongoing documentation improvements.
