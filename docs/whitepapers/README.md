...
**File**: `CLAUDE-CODE-HARNESS-MODERNIZATION-ASP-444.md`
...
These whitepapers document the harness developed during production use on the ASP project and generalized for adoption by other SAFe/Agentic teams.
